...
class InvoiceReportUTD(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('l10n_ru_utd.invoice_report_utd')
    ...
    def get_label(self, invoice):
        ...
        for payment in invoice.invoice_line_ids:
            ...
            result = result + str(move_line.name) + ' от ' + str(move_line.date) + ','
