...
import time
from odoo.addons.l10n_ru_act_sverki.report_helper import QWebHelper


class RuReportPartnerLedgerWithoutStamp(models.AbstractModel):
    _inherit = "report.account.report_partnerledger"
    _name = "report.l10n_ru_act_sverki.report_partnerledger_ru_without_stamp"
    ...
    def render_html(self, docids, data=None):
        ...
        return report_obj.render(
            "l10n_ru_act.report_partnerledger_ru_without_stamp", docargs
        )
